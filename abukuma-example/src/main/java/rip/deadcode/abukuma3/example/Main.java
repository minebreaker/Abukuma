    ...
    public static void main( String[] args ) {
        ...
        Abukuma.config( AbuConfigs.create() )
               .router( AbuRouters.builder()
                                  ...
                                  .file( "/file", Paths.get( "./abukuma-example/src/main/resources/rip/deadcode/abukuma3/example/index.html" ) )
                                  .dir( "/dir", Paths.get( "./abukuma-example/src/main/resources/rip/deadcode/abukuma3/example" ) )
