...
public final class AbuPersistentListMultimap<K, V>
        extends AbstractPersistentListMultimap<K, V, AbuPersistentListMultimap<K, V>> {

    private AbuPersistentListMultimap() {
        super();
    }

    AbuPersistentListMultimap( Envelope<K, V> delegate ) {
        super( delegate );
    }
